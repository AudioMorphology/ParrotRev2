...
void fv_set_samplerate(fv_Context *ctx, float value) {
  //const int combs[] = { 1116, 1188, 1277, 1356, 1422, 1491, 1557, 1617 }; //44100 version
  const int combs[] = { 1215, 1293, 1390, 1476, 1548, 1623, 1695, 1760 };   //48000 version
